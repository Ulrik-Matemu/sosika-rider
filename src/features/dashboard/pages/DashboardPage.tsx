  ...
  return (
    ...
    >
      <div className="space-y-5">
        ...
        {onboardingRequired ? (
          <section className="rounded-[28px] border border-orange-200 bg-[#fff4ea] p-5 text-[#8a3c06] shadow-[0_20px_60px_rgba(15,23,42,0.06)]">
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#b45309]">Action required</p>
            <h3 className="mt-2 text-lg font-semibold text-[#7c2d12]">Complete your rider identity details</h3>
            <p className="mt-2 text-sm leading-6">
              Your account is authenticated, but onboarding is incomplete. Finish your personal details and uploads before review can start.
            </p>
            <Link
              to="/onboarding"
              className="mt-4 inline-flex rounded-[20px] bg-[#111111] px-5 py-3 text-sm font-semibold text-white transition hover:bg-black"
            >
              Continue onboarding
            </Link>
          </section>
